      ...
      <Container>
        <ul className='social list-inline text-center'>
          ...
          <li className='list-inline-item mr-4'>
            ...
            >
              <img src='img/linkedin.svg' width='40' height='40' alt='LinkedIn logo' />
            </a>
          </li>
          <li className='list-inline-item'>
            ...
            >
              <img src='img/instagram.svg' width='40' height='40' alt='Instagram logo' />
            </a>
          </li>
        </ul>
        <span className='d-block text-muted text-center'>
          &copy; {year} Melbourne University Biomedical Engineering Society
        </span>
        <span className='d-block text-muted text-center'>
          ...
          <a
            ...
            rel='noopener noreferrer'
            href='https://github.com/igoresso'
            target='_blank'
          >
            @igoresso
          </a>
